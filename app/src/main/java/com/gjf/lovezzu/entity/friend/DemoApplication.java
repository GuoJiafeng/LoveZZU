package com.gjf.lovezzu.entity.friend;
...
public class DemoApplication extends CheckLoginApplication {
	...
	public void onCreate() {
		...
		instance = this;
		// 初始化环信sdk
		EaseUI.getInstance().init(applicationContext,init(applicationContext));
	...
	public EMOptions init(Context context) {
		// 第一步
